...
DESCRIPTION
  ...
  -1  find regexp matching the name of fastq files containing the #1 mates (passed as -1 to salmon quant).
  -2  find regexp matching the name of fastq files containing the #2 mates (passed as -2 to salmon quant).
